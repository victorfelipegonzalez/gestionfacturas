...
public class EstadisticasAnualClientesReport {
    private static final String RUTA = "src/main/java/com/gestionfacturas/gestionfacturasapi/reports/EstadisticasAnualClientesReport.jasper";

    public static byte[] generarInformeEstadisticas(long id_empresa, int anio) throws JRException {
        try {
            ...
            String directorio = "src/main/java/com/gestionfacturas/gestionfacturasapi/pdf/estadisticasanualclientes.pdf";
